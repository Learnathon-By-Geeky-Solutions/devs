...
class ActivityServiceTest {
    ...
    void create_ShouldCreateNewActivity() {
        ...
        when(modelMapper.map(testActivity, ActivityDto.class))
    ...
    void get_ShouldReturnActivity() {
        // Arrange
        when(activityRepository.findById(testActivityId))
    ...
    void getByDayPlanId_ShouldReturnActivityList() {
        ...
        // Act
        ActivityListResponseDto result = activityService.getByDayPlanId(
            testDayPlanId, pageNumber, pageSize, sortBy, sortDir);
